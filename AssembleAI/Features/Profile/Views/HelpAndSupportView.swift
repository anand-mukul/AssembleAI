...
/// Comprehensive reference manual, physical assembly diagrams, hardware cheat sheets, and FAQ following Apple HIG.
            ...
            VStack(spacing: AppSpacing.lg) {
                ...
                VStack(spacing: AppSpacing.xs) {
                    AnimatedHeaderIcon(
                        ...
                        iconSize: 30,
                        circleDiameter: 64,
                        staticColor: AppColors.badgeIndigo
                    )
                ...
                VStack(spacing: 3) {
                    Text("AssembleAI v\(AppConfig.appVersion) (Build \(AppConfig.buildNumber))")
                        ...
                        .fontWeight(.medium)
                        .foregroundColor(AppColors.secondaryText)
                    Text("Apple Vision • SwiftData • Neural Engine")
                        .font(.caption2)
    ...
    private func referenceCard<Content: View>(
        ...
        VStack(alignment: .leading, spacing: AppSpacing.sm) {
            HStack(spacing: AppSpacing.sm) {
                SemanticIconBadge(iconName: icon, size: 28, iconSize: 14, color: color)
