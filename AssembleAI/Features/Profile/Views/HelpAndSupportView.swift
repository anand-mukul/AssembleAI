...
/// Comprehensive reference manual, physical assembly diagrams, hardware cheat sheets, and FAQ with unified glassmorphism.
    ...
    private func referenceCard<Content: View>(
        ...
        VStack(alignment: .leading, spacing: AppSpacing.sm) {
            HStack(spacing: AppSpacing.sm) {
                GradientIconBadge(iconName: icon, size: 28, iconSize: 13, colors: colors)
